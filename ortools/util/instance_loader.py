...
def load_instance(problem_path: str, time_precision_scaler: int, n_customers=None, n_vehicles=None) -> ProblemInstance:
    """
    ...
    with open(problem_path) as f:
        lines = f.readlines()
    data["num_vehicles"] = int(re.findall("[0-9]+", lines[4])[0]) if n_vehicles is None else n_vehicles
